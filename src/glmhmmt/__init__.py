...
_LAZY_IMPORTS = {
    ...
    "build_transition_weights_df": ("glmhmmt.postprocess", "build_transition_weights_df"),
    "build_posterior_df": ("glmhmmt.postprocess", "build_posterior_df"),
    "build_change_triggered_posteriors_payload": ("glmhmmt.postprocess", "build_change_triggered_posteriors_payload"),
